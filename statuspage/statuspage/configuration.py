...
DATABASE = {
    ...
    'PASSWORD': 'Mh12harel',           # PostgreSQL password
    'HOST': 'status-page.cx248m4we6k7.us-east-1.rds.amazonaws.com',      # Database server
...
SECRET_KEY = 'zQ$i7ksXLwl(Jc4wUaxQ(+eRt_d#Pteadu^gaN=IC1o$use1^w'
